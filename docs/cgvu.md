...
CoursIA est exploité par [Nom / Raison sociale], [Adresse], Suisse. Contact : legal@coursia.app
...
- Une communauté de partage de recettes
...
Conformément au droit suisse, vous disposez d'un droit de rétractation de 14 jours après la souscription d'un abonnement payant, sauf si vous avez expressément demandé à bénéficier du service avant ce délai.

## 6. Données personnelles

Le traitement de vos données est décrit dans `PRIVACY.md`. Conformément à la nLPD, vous disposez d'un droit d'accès, de rectification et d'effacement de vos données personnelles.
...
Règles de contenu : recettes alimentaires uniquement, photos de nourriture uniquement, langue FR/DE/IT. Interdiction : contenu haineux, publicité, spam, plagiat de marques. Le système de signalement (`signalements`) masque automatiquement une recette dès 3 signalements en attente, en file de modération (`recettes_a_moderer`).
...
Les présentes CGVU sont soumises au droit suisse. Tout litige sera soumis aux tribunaux compétents du canton du Valais.
